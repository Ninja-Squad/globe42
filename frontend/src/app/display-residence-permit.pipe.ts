...
export const RESIDENCE_PERMIT_TRANSLATIONS: Array<{ key: ResidencePermit; translation: string; }> = [
  ...
  {key: 'RECEIPT_OF_APPLICATION_FOR_FIRST_RESIDENCE_PERMIT', translation: 'Récépissé de demande de 1ère carte de séjour'},
  {key: 'RECEIPT_OF_RENEWAL_RESIDENCE_PERMIT', translation: 'Récépissé de renouvellement de carte de séjour'},
  ...
  {key: 'TEMPORARY_RESIDENCE_PRIVATE_AND_FAMILY_LIFE', translation: 'Carte de séjour temporaire vie privée et familiale'},
